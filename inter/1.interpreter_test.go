...
func TestPrint1(t *testing.T) {
	...
	f(t, ": t .\" hello world\" ;   t 1 . ", "hello world1")
	f(t, ": t 1 .\" hello world\" ;   t  . ", "hello world1")
...
func TestBrackets(t *testing.T) {
	...
	f(t, ": test noop [ 1000  . ] 5500 . ; test ", "10005500")
...
func TestReturnStack(t *testing.T) {
	...
	f(t, ` : test >r r> ; 1000  test 2000 .  .`, "20001000")
...
func TestName(t *testing.T) {
	...
	f(t, " : t .\" name is \" .name ; ' * 1 - t ", "name is *")
}
...
func TestHereAllot(t *testing.T) {
	...
	f(t, "666 , 888 , here 1 - @ . here 2 - @ . ", "888666")
}
